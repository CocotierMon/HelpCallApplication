...
public class InstitutionMapper {
    ...
    public List<InstitutionDto> mapToInstitutionDtoList(List<Institution> institutionList) {
        return institutionList.stream()
                .map(institutionDto -> new InstitutionDto(institutionDto.getId(), institutionDto.getName(),
                        institutionDto.getEmail(), institutionDto.getNeeds()))
                .collect(Collectors.toList());
    }
}
