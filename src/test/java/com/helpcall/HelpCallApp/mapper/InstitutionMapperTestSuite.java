...
public class InstitutionMapperTestSuite {
    ...
    void testInstitutionMapper() {
        //given
        Institution institution = new Institution(1L, "test", "test@test", "test", "lat",
                "lon", "description","isInstitution", new ArrayList<>());
        Institution institution1 = new Institution(2L, "test2", "test2@test2", "test", "lat",
                "lon", "description","isInstitution", new ArrayList<>());
        Institution institution2 = new Institution(3L, "test3", "test3@test3", "test", "lat",
                "lon", "description","isInstitution", new ArrayList<>());

        InstitutionDto institutionDto = new InstitutionDto(1L, "test2", "test2@test2", "test", "lat",
                "lon", "description","isInstitution", new ArrayList<>());
        InstitutionDto institutionDto1 = new InstitutionDto(2L, "test2", "test2@test2", "test", "lat",
                "lon", "description","isInstitution", new ArrayList<>());
        InstitutionDto institutionDto2 = new InstitutionDto(3L, "test3", "test3@test3", "test", "lat",
                "lon", "description","isInstitution", new ArrayList<>());
